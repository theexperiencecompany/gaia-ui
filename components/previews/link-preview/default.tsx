  ...
  return (
    <div className="flex flex-col gap-4">
      <p className="text-sm leading-relaxed text-foreground">
        ...
        which provides comprehensive guides on building full-stack applications
        with React. The framework offers powerful features like server
        components, streaming, and built-in optimizations for creating fast,

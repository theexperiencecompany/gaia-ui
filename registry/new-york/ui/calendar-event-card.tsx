...
export const EventTitle: FC<EventTitleProps> = ({ children, className }) => (
  <h3 className={cn("font-medium text-zinc-900 dark:text-zinc-100", className)}>{children}</h3>
);
...
export const EventTime: FC<EventTimeProps> = ({ startTime, endTime, className }) => (
...
export const EventLocation: FC<EventLocationProps> = ({ children, className }) => (
  <p className={cn("text-xs text-zinc-500 dark:text-zinc-500", className)}>{children}</p>
);

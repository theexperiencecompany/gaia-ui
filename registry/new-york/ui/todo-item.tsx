...
import { Calendar, Check, Flag, FolderOpen, Tag } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        ...
        {/* Chevron */}
        <div className="flex h-full items-center self-center text-zinc-400 dark:text-zinc-600" aria-hidden="true">
          <svg
            width="20"
            height="20"
            viewBox="0 0 24 24"

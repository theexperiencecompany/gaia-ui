  ...
  const weatherTheme = useMemo(() => {
    ...
    if (weatherId >= 200 && weatherId < 300) {
      ...
      if (weatherId === 701) {
        ...
        return {
          name: "Haze",
          icon: <HazeIcon className="h-16 w-16" color="#FDE68A" />,
        ...
        return {
          name: "Fog",
          icon: <CloudFog className="h-16 w-16" color="#D1D5DB" />,
    ...
    >
      ...
      <div className="mb-3 flex items-start justify-between gap-10">
        <div className="flex items-start">
          <MapPinIcon className="relative top-1 mr-2 h-5 w-5 text-white" />
          <div>
